...
import boot.service.JwtService;
...
public class CustomerController {
	...
	public String greeting() {
		return "Namaskasr...! JWT Security is used";
	}
	...
	public ResponseEntity<String> loginApi(@RequestBody LoginDTO loginDTO) {
		try {
			...
			if (authenticate.isAuthenticated()) {
				...
				return ResponseEntity.status(HttpStatus.OK).body("Logged in Successfully. JWT Token: " + jwtToken);
			}
